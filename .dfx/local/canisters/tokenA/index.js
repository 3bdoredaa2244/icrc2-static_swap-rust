...
import { idlFactory } from './tokenA.did.js';
export { idlFactory } from './tokenA.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TOKENA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tokenA.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tokenA canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tokenA.did.js")._SERVICE>}
 */
export const tokenA = createActor(canisterId);
