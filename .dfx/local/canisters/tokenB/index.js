...
import { idlFactory } from './tokenB.did.js';
export { idlFactory } from './tokenB.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TOKENB;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tokenB.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tokenB canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tokenB.did.js")._SERVICE>}
 */
export const tokenB = createActor(canisterId);
